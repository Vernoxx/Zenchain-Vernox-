...
const CONTRACT_ADDRESS = "0x7D0D2dD25185E5174A2EFB2F5e7960E5e6874990";
const ABI = [
  {
    "inputs": [],
    "name": "mint",
...
// Boost options
const BOOST_OPTIONS = [
  { level: 2, price: 500, img: "/boost-2x.png", title: "Boost x2", desc: "Mine 2x faster. Great for starters!" },
  { level: 4, price: 900, img: "/boost-4x.png", title: "Boost x4", desc: "4x faster, much more efficient." },
  { level: 6, price: 1200, img: "/boost-6x.png", title: "Boost x6", desc: "6x power for pro miners." },
  { level: 8, price: 1500, img: "/boost-8x.png", title: "Boost x8", desc: "8x mining, maximum speed." },
];
            ...
            <div className="zen-toast-alert-glassy">
              <div className="zen-toast-inner">
                ...
                <div className="zen-toast-row">
                  <span className="zen-toast-label">Token Balance</span>
                  <span className="zen-toast-value">{tokenBalance} <span className="ztc-unit">ZTC</span></span>
                </div>
                <div className="zen-toast-row">
                ...
                <div className="zen-toast-row zen-toast-row-after">
                  <span className="zen-toast-label">After Mining</span>
                  <span className="zen-toast-value zen-toast-after">{(tokenBalance - fee).toFixed(4)} <span className="ztc-unit">ZTC</span></span>
                </div>
